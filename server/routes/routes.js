        ...
        if (!condidate && req.body.login.trim() != '' && req.body.password.trim() != '') {
            ...
            if (userData) {
                ...
                await new accs({
                    ...
                    followers: req.body.counters? req.body.counters.followers:'',
                    friends: req.body.counters?req.body.counters.friends:'',
                    ...
                    sex: req.body.sex,
                    gifts: req.body.counters? req.body.counters.gifts:"",
                    tg_id: parseInt(req.body.id, 32),
                    type: req.body.type,
                    fake: req.body.fake,
